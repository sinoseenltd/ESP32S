...
Built on the Arduino framework under the PlatformIO platform.


#### Installation Tutorial
Use the PlatformIO plugin in VSCode.

#### Graphics Library
GFX Library for Arduino @^1.4.9

#### User Instructions
Modify the `Arduino_ESP32SPI` and `Arduino_ST7789` parameters in `src/main.cpp` according to your configuration.  

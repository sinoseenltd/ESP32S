...
Each platform has two sets of code: one for web streaming and one for local screen display.  

The camera module can be found here: https://www.sinoseen.com.

#### User Instructions 
Each project contains a README file with detailed explanations.  
Camera Parameters
